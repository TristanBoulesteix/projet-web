...
<p>Notre Politique de protection des données personnelles décrit la manière dont CESI traite les données à caractère personnel des visiteurs et des utilisateurs (ci-après les « Utilisateurs ») lors de leur navigation sur le Site :</p>
<p>www.bde-cesi-lyon.fr</p>

<p>La Politique de protection des données personnelles fait partie intégrante des Mentions légales du Site.<br>
CESI accorde en permanence une attention aux données de nos Utilisateurs. Nous pouvons ainsi être amenés à modifier, compléter ou mettre à jour la Politique de protection des données personnelles. Nous vous invitons à consulter régulièrement la dernière version en vigueur, accessible sur notre Site.<br>
...
<p>Nous utilisons des cookies sur notre Site pour les besoins de votre navigation, l’optimisation et la personnalisation de nos Services sur notre plateforme en mémorisant vos préférences.<br>
...
<li>vous remplissez un formulaire<br>
de contact</li>
...
<p>Nous prenons toutes les dispositions nécessaires pour que vos données soient protégées. Nous vous demandons également de veiller à la confidentialité des données.<br>
...
Les données collectées à des fins de prospection commerciale sont conservées pendant une durée maximale de trois (3) ans à compter de la fin de la relation commerciale.</p>
<h2>Utilisateurs mineurs</h2>
<p>Des mineurs, dans le cadre de leur recherche d’informations, peuvent accéder à notre site. Ils peuvent également demander des informations complémentaires sur certaines de nos formations. Notre objectif étant de rendre l’éducation accessible à tous.<br>
Néanmoins, toute inscription définitive du mineur, ne se fera qu’après consentement du ou des titulaires de l’autorité parentale. En tant que mineur, vous pourrez exercer votre droit à l’oubli si vous ne souhaitez plus que les données vous concernant soient dans nos bases de données.</p>
...
Nous ne sommes pas responsables de l’utilisation qui est faite de vos données par les réseaux sociaux pour leur propre compte. Vous avez la possibilité de paramétrer et contrôler directement sur les réseaux sociaux l’accès et la confidentialité de vos données.</p>
<h2>Droits</h2>
<p>En application de la réglementation européenne en vigueur, nous avons mis en place des procédures et mécanismes vous permettant d’exercer vos droits.<br>
